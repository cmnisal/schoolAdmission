...
<div class="container">
  ...
  <h3> 11.0 Children of persons arriving after living abroad with the child </h3>
    <div class="form-group">
      <label>11.1 Date returned to the country</label>
     </div>
     <div class="col-sm-4"> 
       
      <select name="rdob" id="rdob" class="form-control input-sm">
    ...
    <div class="form-group col-sm-4">
      ...
      <select name="rmob" id="rmob" class="form-control input-sm">
