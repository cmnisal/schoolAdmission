...
<body style="background-color:#eee;">
  <div class="container">
    ...
    <form action="#" class="form-horizontal" method="POST">
      ...
      <div style="margin-bottom: 25px" class="input-group">
        <label style="background-color:#28a745; color:white;padding:10px;"
        >Age on 31st January 2019</label
        >
      ...
      <div class="row">
        <div class="col-6">
          ...
          <div style="margin-bottom: 25px" class="input-group">
            <label style="background-color:#28a745; color:white;padding:10px;"
            >Divisional Secretariat relevant to the place of living</label
            >
          ...
          <div style="margin-bottom: 25px" class="input-group">
            <label style="background-color:#28a745; color:white;padding:10px;"
            >Grama Niladhari Division and number relevant to the place of
            living</label
            >
        ...
        <div class="col-6">
          ...
          <div style="margin-bottom: 25px" class="input-group">
            ...
            <div class="form-check form-check-inline">
              ...
              type="radio"
              name="spouse_type"
              id="spouse_type_guardian"
              value="guardian"
              />
              <label class="form-check-label" for="spouse_type_guardian"
              >Guardian</label
              >
            </div>
          </div>
          ...
          <div style="margin-bottom: 25px" class="input-group">
            ...
            <div class="form-check form-check-inline">
              ...
              class="form-check-input"
              type="radio"
              name="spouse_srilankan"
              id="spouse_srilankan_yes"
              value="yes"
              />
      ...
      <div class="row">
        <div class="col-4" style="border: 1px solid black; padding:10px">
          ...
          <div style="margin-bottom: 25px" class="input-group">
            <label style="background-color:#28a745; color:white;padding:10px;"
            >Electoral District</label
            >
            <input
            type="text"
            name="electoral_1_district"
            placeholder="Narahenpita"
            style="margin-bottom:8px;"
            />
          </div>
          ...
          <div style="margin-bottom: 25px" class="input-group">
            <label style="background-color:#28a745; color:white;padding:10px;"
            >Grama Niladhari Div and No</label
            >
            <input
            type="text"
            name="electoral_1_grama_div"
            placeholder="005002"
            style="margin-bottom:8px;"
            />
          </div>
          ...
          <div style="margin-bottom: 25px" class="input-group">
            <label style="background-color:#28a745; color:white;padding:10px;"
            >Polling Division:</label
            >
            <input
            type="text"
            name="electoral_1_poll"
            placeholder="098788"
            style="margin-bottom:8px;"
            />
          </div>
          ...
          <div style="margin-bottom: 25px" class="input-group">
            ...
            <input
            type="text"
            name="electoral_1_serial"
            placeholder="M1254564"
            style="margin-bottom:8px;"
            />
          </div>
          ...
          <div style="margin-bottom: 25px" class="input-group">
            <label style="background-color:#28a745; color:white;padding:10px;"
            >Name of Electors (All persons)</label
            >
